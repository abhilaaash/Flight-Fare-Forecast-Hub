...
Original file is located at
    https://colab.research.google.com/drive/1oS81CIqaHDRmBkSa2rhx4w3HohNMiEu3
"""



"""# **Flight Fare Prediction SVM Project**
...
4. Train a Gradient svm Model with hyper-parameter tuning
5. Save Model
6. Export Model
...
print('Model Performance on Training Set:', round(svr.score(X_scaled, y_train)*100,2))
print('Model Performance on Test Set:', round(svr.score(X_scaled_test, y_test)*100,2))
...
param_grid = {
    ...
    # "epsilon": np.arange(0.01, 1.0, 0.01),
...
print('Model Performance on Training Set:', round(grid_search.score(X_scaled, y_train)*100,2))
print('Model Performance on Test Set:', round(grid_search.score(X_scaled_test, y_test)*100,2))
...
file = open('svm_For_Flight_Fare_Prediction.pkl', 'wb')
...
import pickle
path = 'svm_For_Flight_Fare_Prediction.pkl'
model = open(path,'rb')
