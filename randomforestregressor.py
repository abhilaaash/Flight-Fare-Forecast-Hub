...
Original file is located at
    https://colab.research.google.com/drive/1crt6ZGksV5CVHISDpmAb1R-OMK7Lm2iG

# Flight Fare Prediction RandomForestRegressor Project
...
# 4. Train a Random Forest Regressor Model with hyper-parameter tuning
...
datatset_train = pd.concat([Flight_Dataset, Airline, Source, Destination], axis = 1) # axis = 1 signifies column
datatset_train.drop(["Airline", "Source", "Destination"], axis = 1, inplace = True)

datatset_train.head()

datatset_train.shape
...
datatset_train.columns

X = datatset_train.loc[:, ['Total_Stops', 'journey_day', 'journey_month', 'dep_hour',
       'dep_min', 'arrival_hour', 'arrival_min', 'Duration_hours',
       'Duration_mins', 'Airline_Air India',
       'Airline_GoAir', 'Airline_IndiGo', 'Airline_Jet Airways',
       'Airline_Multiple carriers', 'Airline_Other', 'Airline_SpiceJet',
       'Airline_Vistara', 'Source_Chennai', 'Source_Delhi',
       'Source_Kolkata', 'Source_Mumbai', 'Destination_Cochin',
       'Destination_Delhi', 'Destination_Hyderabad', 'Destination_Kolkata']]
y = datatset_train.iloc[:, 1]
...
file = open('RandomForestRegressor_For_Flight_Fare_Prediction.pkl', 'wb')
...
import pickle
path = 'RandomForestRegressor_For_Flight_Fare_Prediction.pkl'
model = open(path,'rb')
...
dfx.to_excel("RandomForestRegresso_output.xlsx")
dfx.head()
