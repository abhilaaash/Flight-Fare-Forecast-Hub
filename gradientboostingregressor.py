...
Original file is located at
    https://colab.research.google.com/drive/1ZVj8nNsZKQHg2AbaUPBZYWVLZVcRqgis

# **Flight Fare Prediction GradientBoostingRegressor Project**
...
4. Train a Gradient BoostingRegressor Model with hyper-parameter tuning
5. Save Model
6. Export Model
...
print('Model Performance on Training Set:', round(gbt.score(X_train, y_train)*100,2))
print('Model Performance on Test Set:', round(gbt.score(X_test, y_test)*100,2))
...
# Create the Gradient Boosting Trees regressor
gbrt = GradientBoostingRegressor()

# Create the GridSearchCV object
grid_search = GridSearchCV(gbrt, param_distributions, n_jobs=-1, cv=5)
...
file = open('GradientBoostingRegressor_For_Flight_Fare_Prediction.pkl', 'wb')
...
import pickle
path = 'GradientBoostingRegressor_For_Flight_Fare_Prediction.pkl'
model = open(path,'rb')
...
dfx.to_excel("GradientBoostingRegressor.xlsx")
dfx.head()
