...
Original file is located at
    https://colab.research.google.com/drive/1iVDjvVwNRmUbRgP9RskUnSM_cf0v91Ll

# **Flight Fare Prediction AdaBoostRegressor Project**
...
4. Train a  AdaBoost Regressor Model with hyper-parameter tuning
5. Save Model
6. Export Model
...
## **Perform the AdaBoost Regressor:**
...
ada = AdaBoostRegressor(n_estimators=100, learning_rate=0.1, random_state=42, estimator=ExtraTreeRegressor())
ada.fit(X_train, y_train)

"""### Model Performance"""

print('Model Performance on Training Set:', round(ada.score(X_train, y_train)*100,2))
print('Model Performance on Test Set:', round(ada.score(X_test, y_test)*100,2))
...
file = open('AdaBoostRegressor_For_Flight_Fare_Prediction.pkl', 'wb')
...
import pickle
path = 'AdaBoostRegressor_For_Flight_Fare_Prediction.pkl'
model = open(path,'rb')
adar = pickle.load(model)
...
y_pred = adar.predict(X_test_new)
...
dfx.to_excel("AdaBoostRegressor.xlsx")
dfx.head()
