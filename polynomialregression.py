...
Original file is located at
    https://colab.research.google.com/drive/1UwDo29e7VEjTVssVVpktq5DrsrdUJCWU

# **Flight Fare Prediction Polynomial Regression Project**
...
4. Train a Polynomial Regression Model with hyper-parameter tuning
5. Save Model
6. Export Model
...
## **Perform the Polynomial Regressor:**
...
print('Model Performance on Training Set:', round(lin_reg.score(X_poly, y_train)*100,2))
print('Model Performance on Test Set:', round(lin_reg.score(X_new, y_test)*100,2))
...
file = open('PolynomialRegression_For_Flight_Fare_Prediction.pkl', 'wb')
...
import pickle
path = 'PolynomialRegression_For_Flight_Fare_Prediction.pkl'
model = open(path,'rb')
pr = pickle.load(model)
...
# Fit the linear regression model to the polynomial features
X_poly = poly_features.fit_transform(X_test_new)
...
dfx.to_excel("PolynomialRegression.xlsx")
dfx.head()