...
Original file is located at
    https://colab.research.google.com/drive/1RmhMsFgrox66mYF_pvOBh91aAQv4jA7s

# **Flight Fare Prediction XGBRegressor Project**
...
4. Train a  XGBRegressor Model with hyper-parameter tuning
5. Save Model
6. Export Model
...
## **Perform the XGBRegressor Regressor:**
...
xgb_model = xgb.XGBRegressor(n_estimators=100, max_depth=5, random_state=42,booster='dart' )
xgb_model.fit(X_train, y_train)

print('Model Performance on Training Set:', round(xgb_model.score(X_train, y_train)*100,2))
print('Model Performance on Test Set:', round(xgb_model.score(X_test, y_test)*100,2))
...
file = open('XGBRegressor_For_Flight_Fare_Prediction.pkl', 'wb')
...
import pickle
path = 'XGBRegressor_For_Flight_Fare_Prediction.pkl'
model = open(path,'rb')
...
dfx.to_excel("XGBRegressor.xlsx")
dfx.head()
