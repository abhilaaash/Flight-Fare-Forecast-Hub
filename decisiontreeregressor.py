...
Original file is located at
    https://colab.research.google.com/drive/1P98Wdtz4_5sy15C45HVe-cIOAepKOt4r

# **Flight Fare Prediction Decision Tree Regressor Project**
...
4. Train a Decision Tree Regressor Model with hyper-parameter tuning
5. Save Model
6. Export Model
...
## **Perform the DecisionTreeRegressor :**
...
file = open('DecisionTreeRegressorn_For_Flight_Fare_Prediction.pkl', 'wb')
...
import pickle
path = 'DecisionTreeRegressorn_For_Flight_Fare_Prediction.pkl'
model = open(path,'rb')
dtr = pickle.load(model)
...
dfx.to_excel("DecisionTreeRegressor.xlsx")
dfx.head()
